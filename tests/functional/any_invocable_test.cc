...
static_assert(std::is_constructible<Wrapper<turbo::AnyInvocable<void()>>,
                                    Wrapper<turbo::AnyInvocable<void()>>>::value,
              "");
...
// build binaries for.
static_assert(
    std::is_convertible<void (*)(), turbo::AnyInvocable<void() &&>>::value, "");
