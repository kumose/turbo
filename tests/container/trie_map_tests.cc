...
#include <turbo/container/htrie_map.h>
#include "utils.h"

BOOST_AUTO_TEST_SUITE(test_htrie_map)

using test_types = boost::mpl::list<turbo::htrie_map<char, std::int64_t>,
                                    turbo::htrie_map<char, std::string>,
                                    turbo::htrie_map<char, throw_move_test>,
                                    turbo::htrie_map<char, move_only_test>>;
...
BOOST_AUTO_TEST_CASE(test_insert_with_too_long_string) {
  turbo::htrie_map<char, std::int64_t, turbo::ah::str_hash<char>, std::uint8_t> map;
...
BOOST_AUTO_TEST_CASE(test_range_erase) {
  ...
  using TMap = turbo::htrie_map<char, std::int64_t>;
...
BOOST_AUTO_TEST_CASE(test_emplace) {
  turbo::htrie_map<char, move_only_test> map;
  map.emplace("test1", 1);
...
BOOST_AUTO_TEST_CASE(test_longest_prefix) {
  turbo::htrie_map<char, int> map(4);
...
BOOST_AUTO_TEST_CASE(test_for_each_prefix_of) {
  using map_type = turbo::htrie_map<char, int>;
...
BOOST_AUTO_TEST_CASE(test_erase_prefix) {
  turbo::htrie_map<char, std::int64_t> map =
      utils::get_filled_map<turbo::htrie_map<char, std::int64_t>>(10000, 200);
...
BOOST_AUTO_TEST_CASE(test_erase_prefix_all_1) {
  turbo::htrie_map<char, std::int64_t> map =
      utils::get_filled_map<turbo::htrie_map<char, std::int64_t>>(1000, 8);
...
BOOST_AUTO_TEST_CASE(test_compare) {
  ...
  turbo::htrie_map<char, std::int64_t> map2 = {
      {"test3", 30}, {"test2", 20}, {"test1", 10}};
  turbo::htrie_map<char, std::int64_t> map3 = {
      {"test1", 10}, {"test2", 20}, {"test3", -1}};
  turbo::htrie_map<char, std::int64_t> map4 = {{"test3", 30}, {"test2", 20}};
...
BOOST_AUTO_TEST_CASE(test_clear) {
  turbo::htrie_map<char, std::int64_t> map = {{"test1", 10}, {"test2", 20}};
...
BOOST_AUTO_TEST_CASE(test_copy_operator) {
  turbo::htrie_map<char, std::int64_t> map =
      utils::get_filled_map<turbo::htrie_map<char, std::int64_t>>(1000, 8);
  turbo::htrie_map<char, std::int64_t> map2 = map;
  turbo::htrie_map<char, std::int64_t> map3;
  map3 = map;
...
BOOST_AUTO_TEST_CASE(test_move_operator) {
  ...
  const turbo::htrie_map<char, std::int64_t> init_map =
      utils::get_filled_map<turbo::htrie_map<char, std::int64_t>>(nb_elements, 8);

  turbo::htrie_map<char, std::int64_t> map =
      utils::get_filled_map<turbo::htrie_map<char, std::int64_t>>(nb_elements, 8);
  turbo::htrie_map<char, std::int64_t> map2 =
      utils::get_filled_map<turbo::htrie_map<char, std::int64_t>>(1, 8);
  map2 = std::move(map);
  ...
  map2 = {{"test1", 10}};
  BOOST_CHECK(map2 == (turbo::htrie_map<char, std::int64_t>{{"test1", 10}}));
}
...
BOOST_AUTO_TEST_CASE(test_at) {
  ...
  const turbo::htrie_map<char, std::int64_t> map_const = {
...
BOOST_AUTO_TEST_CASE(test_swap) {
  ...
  BOOST_CHECK(map == (turbo::htrie_map<char, std::int64_t>{
                         {"test3", 30}, {"test4", 40}, {"test5", 50}}));
  BOOST_CHECK(map2 == (turbo::htrie_map<char, std::int64_t>{{"test1", 10},
                                                          {"test2", 20}}));
}
...
BOOST_AUTO_TEST_CASE(test_serialize_deserialize_empty_map) {
  ...
  const turbo::htrie_map<char, move_only_test> empty_map;
...
BOOST_AUTO_TEST_CASE(test_serialize_deserialize_map) {
  ...
  turbo::htrie_map<char, move_only_test> map(7);
...
BOOST_AUTO_TEST_CASE(test_serialize_deserialize_with_different_hash) {
  ...
  struct str_hash {
    std::size_t operator()(const char* key, std::size_t key_size) const {
      return turbo::ah::str_hash<char>()(key, key_size) + 123;
    }
  };
  ...
  auto map_deserialized =
      turbo::htrie_map<char, move_only_test, str_hash>::deserialize(dserial);
...
BOOST_AUTO_TEST_CASE(test_serialize_deserialize_map_no_burst) {
  ...
  turbo::htrie_map<char, move_only_test> map(nb_values + 1);
