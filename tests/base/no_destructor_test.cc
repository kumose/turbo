...
TEST(NoDestructorTest, Interface) {
  EXPECT_TRUE(std::is_trivially_destructible<turbo::NoDestructor<Blob>>::value);
  EXPECT_TRUE(
      std::is_trivially_destructible<turbo::NoDestructor<const Blob>>::value);
  {
...
TEST(NoDestructorTest, StaticPattern) {
  EXPECT_TRUE(
      std::is_trivially_destructible<turbo::NoDestructor<std::string>>::value);
  EXPECT_TRUE(
      std::is_trivially_destructible<turbo::NoDestructor<MyArray>>::value);
  EXPECT_TRUE(
      std::is_trivially_destructible<turbo::NoDestructor<MyVector>>::value);
  EXPECT_TRUE(std::is_trivially_destructible<turbo::NoDestructor<int>>::value);
...
// provided for turbo::NoDestructor.
TEST(NoDestructorTest, ClassTemplateArgumentDeduction) {
  turbo::NoDestructor i(1);
  static_assert(std::is_same<decltype(i), turbo::NoDestructor<int>>::value,
