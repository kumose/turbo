...
namespace {
    ...
    TURBO_FORCE_INLINE void Vector128Store(
    ...
    TURBO_FORCE_INLINE void BlockShuffle(
            turbo::uint128 *state) {
    ...
    TURBO_FORCE_INLINE const turbo::uint128 *
    FeistelRound(turbo::uint128 *TURBO_RESTRICT state,
                 const turbo::uint128 *TURBO_RESTRICT keys) {
    ...
    TURBO_FORCE_INLINE void Permute(
            turbo::uint128 *state,
            const turbo::uint128 *TURBO_RESTRICT keys) {
    ...
    TURBO_FORCE_INLINE void SwapEndian(
            turbo::uint128 *state) {
...
namespace turbo::random_internal {
    ...
    void RandenSlow::Absorb(const void *seed_void, void *state_void) {
        auto *state =
                reinterpret_cast<uint64_t *TURBO_RESTRICT>(state_void);
        const auto *seed =
                reinterpret_cast<const uint64_t *TURBO_RESTRICT>(
                        seed_void);
