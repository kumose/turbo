...
//
// A value of 1 means to use aliases.  This requires that all code using Turbo
...
// not be used otherwise -- for example, if you are distributing Turbo in a
...
#define TURBO_OPTION_USE_STD_ORDERING 2
