...
//
//
// turbo::base_internal::invoke(f, args...) is an implementation of
...
struct MemFunAndRef : StrippedAccept<MemFunAndRef> {
  ...
  struct AcceptImpl<MemFunType C::*, Obj, Args...>
      : std::integral_constant<bool, std::is_base_of<C, Obj>::value &&
                                         std::is_function<MemFunType>::value> {
  };
...
struct IsInvocableRImpl<
    std::void_t<turbo::base_internal::invoke_result_t<F, Args...> >, R, F,
    Args...>
    : std::integral_constant<
          bool,
          std::is_convertible<turbo::base_internal::invoke_result_t<F, Args...>,
                              R>::value ||
              std::is_void<R>::value> {};
