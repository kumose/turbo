...
#define TURBO_FORCE_INLINE __attribute__((always_inline)) inline
#define TURBO_LAMBDA_FORCE_INLINE __attribute__((always_inline))
#define TURBO_HAVE_ATTRIBUTE_ALWAYS_INLINE 1
#else
#define TURBO_FORCE_INLINE inline
#define TURBO_LAMBDA_FORCE_INLINE
#endif

#if TURBO_HAVE_ATTRIBUTE(noinline) || (defined(__GNUC__) && !defined(__clang__))
#define TURBO_NOINLINE __attribute__((noinline))
#define TURBO_HAVE_ATTRIBUTE_NOINLINE 1
#else
#define TURBO_NOINLINE
#endif
...
#define TURBO_DISABLE_DEPRECATED_DECLARATION_WARNING \
  _Pragma("GCC diagnostic push")             \
  _Pragma("GCC diagnostic ignored \"-Wdeprecated-declarations\"")
#define TURBO_RESTORE_DEPRECATED_DECLARATION_WARNING \
