...
#include <turbo/base/macros/attributes.h>
#include <turbo/base/macros/config.h>
#include <turbo/base/macros/optimization.h>
#include <turbo/base/macros/basic.h>
#include <turbo/base/macros/testing.h>
#include <turbo/base/macros/pretty_function.h>
#include <turbo/base/macros/signal.h>
...
/// \macro TURBO_GNUC_PREREQ
/// Extend the default __GNUC_PREREQ even if glibc's features.h isn't
/// available.
#ifndef TURBO_GNUC_PREREQ
# if defined(__GNUC__) && defined(__GNUC_MINOR__) && defined(__GNUC_PATCHLEVEL__)
#  define TURBO_GNUC_PREREQ(maj, min, patch) \
...
# else
#  define TURBO_GNUC_PREREQ(maj, min, patch) 0
# endif
#endif
