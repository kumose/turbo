...
// void PaySalary(turbo::Nonnull<Employee *> e) {
//   pay(e->salary);  // OK to dereference
// }
//
// // CompleteTransaction() guarantees the returned pointer to an `Account` to
// // be non-null.
// turbo::Nonnull<Account *> balance CompleteTransaction(double fee) {
// ...
// }
//
...
// annotations by providing an `turbo_nullability_compatible` nested type. The
...
// `turbo_nullability_compatible` set to void.
//
// // Example:
// struct MyPtr {
//   using turbo_nullability_compatible = void;
//   ...
// };
//
// DISCLAIMER:
...
#include <turbo/base/internal/nullability_impl.h>
...
// void PaySalary(turbo::Nonnull<Employee *> employee) {
...
// void PaySalary(turbo::Nullable<Employee *> employee) {
//   if (employee != nullptr) {
//     Pay(*employee);  // OK to dereference
//   }
// }
...
// turbo::NullabilityUnknown (default)
//
...
// void PaySalary(turbo::NullabilityUnknown<Employee *> employee) {
