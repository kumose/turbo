...
class FixedArray {
 ...
 public:
  ...
  const_pointer data() const TURBO_ATTRIBUTE_LIFETIME_BOUND {
  ...
  // elements.
  pointer data() TURBO_ATTRIBUTE_LIFETIME_BOUND {
    return AsValueType(storage_.begin());
  }
  ...
  iterator begin() TURBO_ATTRIBUTE_LIFETIME_BOUND { return data(); }

  // Overload of FixedArray::begin() to return a const iterator to the
  // beginning of the fixed array.
  const_iterator begin() const TURBO_ATTRIBUTE_LIFETIME_BOUND { return data(); }
  ...
  iterator end() TURBO_ATTRIBUTE_LIFETIME_BOUND { return data() + size(); }
  ...
  reverse_iterator rend() TURBO_ATTRIBUTE_LIFETIME_BOUND {
  ...
  template <typename H>
  friend H turbo_hash_value(H h, const FixedArray& v) {
