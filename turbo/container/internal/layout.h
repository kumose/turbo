...
class LayoutImpl<
    std::tuple<Elements...>, turbo::index_sequence<StaticSizeSeq...>,
    turbo::index_sequence<RuntimeSizeSeq...>, turbo::index_sequence<SizeSeq...>,
 ...
 public:
  ...
  template <class Char>
  auto Slices(TURBO_ATTRIBUTE_UNUSED Char* p) const {
...
constexpr std::array<size_t, sizeof...(StaticSizeSeq)> LayoutImpl<
    std::tuple<Elements...>, turbo::index_sequence<StaticSizeSeq...>,
    turbo::index_sequence<RuntimeSizeSeq...>, turbo::index_sequence<SizeSeq...>,
    turbo::index_sequence<OffsetSeq...>>::kStaticSizes;

template <class StaticSizeSeq, size_t NumRuntimeSizes, class... Ts>
using LayoutType = LayoutImpl<
    std::tuple<Ts...>, StaticSizeSeq,
    turbo::make_index_sequence<NumRuntimeSizes>,
    turbo::make_index_sequence<NumRuntimeSizes + StaticSizeSeq::size()>,
    turbo::make_index_sequence<adl_barrier::Min(
...
class Layout : public internal_layout::LayoutWithStaticSizes<
                   turbo::make_index_sequence<0>, Ts...> {
 private:
  using Super =
      internal_layout::LayoutWithStaticSizes<turbo::make_index_sequence<0>,
                                             Ts...>;
