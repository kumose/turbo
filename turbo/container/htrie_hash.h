...
#include <turbo/container/trie/array_map.h>
#include <turbo/container/trie/array_set.h>
#include <string_view>
...
class htrie_hash {
 ...
 private:
  using array_hash_type = typename std::conditional<
      has_value<T>::value,
      turbo::array_map<CharT, T, Hash, turbo::ah::str_equal<CharT>, false, KeySizeT,
                     std::uint16_t, turbo::ah::power_of_two_growth_policy<4>>,
          turbo::array_set<CharT, Hash, turbo::ah::str_equal<CharT>, false, KeySizeT,
                     std::uint16_t,
                  turbo::ah::power_of_two_growth_policy<4>>>::type;
 ...
 private:
  ...
  using value_node = turbo::detail_htrie_hash::value_node<T>;
