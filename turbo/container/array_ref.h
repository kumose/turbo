...
namespace turbo {
    ...
    /// value.
    template<typename T>
    class TURBO_GSL_POINTER [[nodiscard]] ArrayRef {
    public:
        using value_type = T;
...
#pragma GCC diagnostic pop
    ...
    /// Construct an ArrayRef from a single element.
    template<typename T>
    TURBO_DEPRECATED("Use deduction guide instead ArrayRef")
    ...
    /// Construct a MutableArrayRef from a single element.
    template<typename T>
    TURBO_DEPRECATED("Use deduction guide instead MutableArrayRef")
