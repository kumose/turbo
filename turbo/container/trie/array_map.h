 ...
 */
template <class CharT, class T, class Hash = turbo::ah::str_hash<CharT>,
...
class array_map {
 private:
  ...
  using ht = turbo::detail_array_hash::array_hash<CharT, T, Hash, KeyEqual,
...
/**
 * Same as
 * `turbo::array_map<CharT, T, Hash, KeyEqual, StoreNullTerminator, KeySizeT,
