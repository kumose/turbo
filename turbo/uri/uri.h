...
namespace turbo {
    ...
    class TURBO_DLL Uri {
            ...
            turbo::Result<std::vector<std::pair<std::string, std::string>>> query_items() const;

            /// Get the string representation of this URI.
            const std::string& to_string() const;

            /// Factory function to parse a URI from its string representation.
            turbo::Status parse(const std::string& uri_string);

            /// Factory function to parse a URI from its string representation.
            static turbo::Result<Uri> from_string(const std::string& uri_string);
    ...
    TURBO_DLL turbo::Result<std::string> uri_from_absolute_path(std::string_view path);
