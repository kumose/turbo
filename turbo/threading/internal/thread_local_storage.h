...
class TURBO_EXPORT PlatformThreadLocalStorage {
 public:
...
class TURBO_EXPORT ThreadLocalStorage {
 public:
...
#define TLS_INITIALIZER {false, 0}
  ...
  struct TURBO_EXPORT StaticSlot {
  ...
  class TURBO_EXPORT Slot : public StaticSlot {
   public:
   ...
   private:
    ...
    TURBO_DISALLOW_COPY_AND_ASSIGN(Slot);
  };

  TURBO_DISALLOW_COPY_AND_ASSIGN(ThreadLocalStorage);
};
