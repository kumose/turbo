...
#define TURBO_VOLATILE_THREAD_LOCAL(type, var_name, default_value)             \
  TURBO_THREAD_LOCAL type var_name = default_value;                            \
...
#define TURBO_GET_VOLATILE_THREAD_LOCAL(var_name) get_##var_name()
#define TURBO_GET_PTR_VOLATILE_THREAD_LOCAL(var_name) get_ptr_##var_name()
#define TURBO_SET_VOLATILE_THREAD_LOCAL(var_name, value) set_##var_name(value)
#else
#define TURBO_GET_VOLATILE_THREAD_LOCAL(var_name) var_name
#define TURBO_GET_PTR_VOLATILE_THREAD_LOCAL(var_name) &##var_name
#define TURBO_SET_VOLATILE_THREAD_LOCAL(var_name, value) var_name = value
#endif
...
#include <turbo/threading/thread_local_inl.h>
