...
namespace turbo {
    ...
    namespace status_internal {
        ...
        using Payloads = turbo::InlinedVector<std::shared_ptr<StatusPayload>, 1>;
        ...
        public:
            ...
            const std::shared_ptr<StatusPayload> &get_payload(std::string_view type_url) const;

            std::shared_ptr<StatusPayload> &get_payload(std::string_view type_url);

            void set_payload(std::shared_ptr<StatusPayload> payload);
            ...
            std::string to_string(StatusToStringMode mode) const;
