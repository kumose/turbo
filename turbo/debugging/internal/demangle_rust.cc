...
class RustSymbolParser {
 public:
  ...
  // again.
  TURBO_MUST_USE_RESULT bool Parse() && {
...
#define TURBO_DEMANGLER_RECURSE(callee, caller) \
 ...
 private:
  ...
  TURBO_MUST_USE_RESULT bool Eat(char want) {
  ...
  TURBO_MUST_USE_RESULT bool EmitChar(char c) {
  ...
  TURBO_MUST_USE_RESULT bool Emit(const char* token) {
    if (silence_depth_ > 0) return true;
  ...
  TURBO_MUST_USE_RESULT bool EmitDisambiguator(int disambiguator) {
  ...
  TURBO_MUST_USE_RESULT bool ParseDisambiguator(int& value) {
    value = -1;
  ...
  // value to -1.
  TURBO_MUST_USE_RESULT bool ParseBase62Number(int& value) {
    value = -1;
  ...
  TURBO_MUST_USE_RESULT bool ParseIdentifier(char uppercase_namespace = '\0') {
  ...
  TURBO_MUST_USE_RESULT bool ParseUndisambiguatedIdentifier(
  ...
  TURBO_MUST_USE_RESULT bool ParseDecimalNumber(int& value) {
    value = -1;
    if (!IsDigit(Peek())) return false;
  ...
  // returns false.
  TURBO_MUST_USE_RESULT bool ParseOptionalBinder() {
  ...
  TURBO_MUST_USE_RESULT bool ParseOptionalLifetime() {
  ...
  TURBO_MUST_USE_RESULT bool ParseRequiredLifetime() {
  ...
  TURBO_MUST_USE_RESULT bool PushNamespace(char ns) {
  ...
  TURBO_MUST_USE_RESULT bool PushPosition(int position) {
  ...
  // is out of range.
  TURBO_MUST_USE_RESULT bool BeginBackref() {
    // backref = B base-62-number (B already consumed)
    //
