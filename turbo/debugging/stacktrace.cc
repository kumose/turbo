...
TURBO_NOINLINE TURBO_ATTRIBUTE_NO_TAIL_CALL int GetStackFrames(
    void** result, int* sizes, int max_depth, int skip_count) {
  return Unwind<true, false>(result, sizes, max_depth, skip_count, nullptr,
                             nullptr);
}

TURBO_NOINLINE TURBO_ATTRIBUTE_NO_TAIL_CALL int
...
TURBO_NOINLINE TURBO_ATTRIBUTE_NO_TAIL_CALL int GetStackTrace(
