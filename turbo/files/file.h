...
namespace turbo {
    ...
    // member variables.
    class TURBO_EXPORT File {
    private:
        struct RValue {
            explicit RValue(File *object) : object(object) {}
    ...
    public:
        ...
        File Pass() { return File(RValue(this)); }
    ...
    public:
        ...
        // too, and the ParamTraits<turbo::PlatformFileInfo> implementation in
        // chrome/common/common_param_traits.cc.
        struct TURBO_EXPORT Info {
            Info();
            ...
            turbo::Time last_modified;

            // The last accessed time of a file.
            turbo::Time last_accessed;

            // The creation time of a file.
            turbo::Time creation_time;
        };
        ...
        File(const turbo::FilePath &name, uint32_t flags);
        ...
        void initialize(const turbo::FilePath &name, uint32_t flags);

        // Creates or opens the given file, allowing paths with traversal ('..')
        // components. Use only with extreme care.
        void initialize_unsafe(const turbo::FilePath &name, uint32_t flags);
        ...
        // the success of the operation is to use is_valid(), not this method:
        ...
        bool set_times(turbo::Time last_access_time, turbo::Time last_modified_time);
