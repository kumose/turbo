...
#define TURBO_CORD_INTERNAL_NO_SANITIZE \
  TURBO_ATTRIBUTE_NO_SANITIZE_ADDRESS TURBO_ATTRIBUTE_NO_SANITIZE_MEMORY
...
// holds 'value`, with all other bytes being 0.
        ...
        private:
            struct Rep {
                ...
                TURBO_CORD_INTERNAL_NO_SANITIZE
