...
// at compile time.
inline void *non_temporal_store_memcpy(void *TURBO_RESTRICT dst,
                                       const void *TURBO_RESTRICT src, size_t len) {
...
[[gnu::target("avx")]]
#endif
inline void *non_temporal_store_memcpy_avx(void *TURBO_RESTRICT dst,
