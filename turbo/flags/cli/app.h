...
#include <turbo/flags/cli/formatter_fwd.h>
#include <turbo/base/macros.h>
#include <turbo/flags/cli/option.h>
#include <turbo/flags/cli/split.h>
#include <turbo/flags/cli/string_tools.h>
#include <turbo/flags/cli/type_tools.h>
#include <turbo/flags/flag.h>

namespace turbo::cli {

#ifndef TURBO_APP_PARSE
#define TURBO_APP_PARSE(app, ...)                                                                                          \
    try {                                                                                                              \
    ...
    public:
        ...
        Option *add_option(std::string option_name,
            ...
            auto fun = [&variable](const turbo::cli::results_t &res) {  // comment for spacing
                return detail::lexical_conversion<AssignTo, ConvertTo>(res, variable);
            };

            Option *opt = add_option(option_name, fun, option_description, false, [&variable]() {
                return turbo::cli::detail::checked_to_string<AssignTo, ConvertTo>(variable);
            });
        ...
        Option *add_option_function(std::string option_name,
            ...
            auto fun = [func](const turbo::cli::results_t &res) {
                ArgType variable;
        ...
        Option *add_option(std::string option_name) {
            return add_option(option_name, turbo::cli::callback_t{}, std::string{}, false);
        }
        ...
        Option *add_option(std::string option_name, T &option_description) {
            return add_option(option_name, turbo::cli::callback_t(), option_description, false);
        }
    ...
    private:
        ...
        Option *_add_flag_internal(std::string flag_name, turbo::cli::callback_t fun, std::string flag_description);

    public:
        /// Add a flag with no description or variable assignment
        Option *add_flag(std::string flag_name) {
            return _add_flag_internal(flag_name, turbo::cli::callback_t(), std::string{});
        }
        ...
        Option *add_flag(std::string flag_name, T &flag_description) {
            return _add_flag_internal(flag_name, turbo::cli::callback_t(), flag_description);
        }
        ...
        Option *add_flag(std::string flag_name,
            ...
            turbo::cli::callback_t fun = [&flag_result](const turbo::cli::results_t &res) {
        ...
        Option *add_flag(std::string flag_name,
                         ...
                         std::string flag_description = "") {
            turbo::cli::callback_t fun = [&flag_results](const turbo::cli::results_t &res) {
                bool retval = true;
        ...
        App *add_subcommand(turbo::cli::App_p subcom);
        ...
        turbo::cli::App_p get_subcommand_ptr(App *subcom) const;

        /// Check to see if a subcommand is part of this command (text version)
        [[nodiscard]] turbo::cli::App_p get_subcommand_ptr(std::string subcom) const;

        /// Get an owning pointer to subcommand by index
        [[nodiscard]] turbo::cli::App_p get_subcommand_ptr(int index = 0) const;
    ...
    public:
        ...
        App* enable_all_flags_option();
        /// if the flag not exists, do nothing
        App* enable_flags_option(std::string_view flag_name);
        template <typename T>
        App* enable_flags_option(const turbo::Flag<T> &flag) {
            return enable_flags_option(flag.name());
        }
        ///@}
