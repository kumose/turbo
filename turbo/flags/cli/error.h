...
///
/// These are the errors that can be thrown. Some of them, like turbo::cli::Success, are not really errors.
/// @{
...
/// Does not output a diagnostic in TURBO_APP_PARSE, but allows main() to return with a specific error code.
