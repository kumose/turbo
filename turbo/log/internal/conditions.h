...
// -----------------------------------------------------------------------------
//
// This file contains implementation of conditional log statements, like KLOG_IF
...
// macro (e.g. `KLOG_IF` or `VKLOG`) with inherent conditions (e.g.
...
#define TURBO_LOG_INTERNAL_CONDITION_DFATAL(type, condition)             \
  TURBO_LOG_INTERNAL_##type##_CONDITION(                                 \
      (TURBO_ASSUME(turbo::kLogDebugFatal == turbo::LogSeverity::kError || \
