...
class VLogSite final {
 ...
 private:
  ...
  TURBO_NOINLINE bool SlowIsEnabled0(int stale_v);
  TURBO_NOINLINE bool SlowIsEnabled1(int stale_v);
  TURBO_NOINLINE bool SlowIsEnabled2(int stale_v);
  TURBO_NOINLINE bool SlowIsEnabled3(int stale_v);
  TURBO_NOINLINE bool SlowIsEnabled4(int stale_v);
  TURBO_NOINLINE bool SlowIsEnabled5(int stale_v);
