...
namespace turbo {
    ...
    namespace log_internal {
        ...
        LogMessage::LogMessageData::LogMessageData(const char *file, int line,
            ...
            // Legacy defaults for KLOG's ostream:
        ...
        LogMessage &LogMessage::no_newline() {
            data_->entry.newline_ = false;
            return *this;
        }
        ...
        LogMessage &LogMessage::with_app_info(AppInfo info) {
            data_->entry.app_info_ = std::move(info);
            return *this;
        }
        ...
        LogMessage &LogMessage::to_sink_also(turbo::LogSink *sink) {
            TURBO_INTERNAL_CHECK(sink, "null LogSink*");
            data_->extra_sinks.push_back(sink);
            return *this;
        }

        LogMessage &LogMessage::to_sink_only(turbo::LogSink *sink) {
            TURBO_INTERNAL_CHECK(sink, "null LogSink*");
