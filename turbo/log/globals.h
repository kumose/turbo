...
namespace turbo {
    ...
    //------------------------------------------------------------------------------
    //
    // Users can request an existing `KLOG` statement, specified by file and line
    ...
    // location isn't a `KLOG` statement, the effect will be the same as
    ...
    //------------------------------------------------------------------------------
    // Set Global VKLOG Level
    //------------------------------------------------------------------------------
    //
    // Sets the global `(TURBO_)VKLOG(_IS_ON)` level to `log_level`.  This level is
    ...
    //------------------------------------------------------------------------------
    //
    // Sets `(TURBO_)VKLOG(_IS_ON)` level for `module_pattern` to `log_level`.  This
