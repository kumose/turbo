...
namespace turbo {
    RotatingFileSink::RotatingFileSink(std::string_view base_filename, std::size_t max_size,
                                       std::size_t max_files, int check_interval_s) : _raw_base_filename(base_filename),
        _base_filename(base_filename), max_size_(max_size), max_files_(max_files), _check_interval_s(check_interval_s),
        ...
        _file_writer->initialize(_raw_base_filename);
